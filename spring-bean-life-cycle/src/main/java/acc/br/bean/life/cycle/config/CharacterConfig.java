...
class CharacterConfig {
    ...
    @Bean (initMethod = "customInitW", destroyMethod = "customDestroyW")
    public Weapon sword() {
        return new Weapon("Sword of Fire and Ice");
    }

    @Bean (initMethod = "customInitI", destroyMethod = "customDestroyI")
    public Item potion() {
